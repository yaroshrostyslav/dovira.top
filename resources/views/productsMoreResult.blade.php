...
<div class="container">
    @if (Route::has('login'))
        <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom shadow-sm">
            <h4 class="my-0 mr-md-auto font-weight-normal">Dovira.top</h4>
            ...
            @auth
                ...
                <a class="btn btn-outline-primary" href="{{ url('/contacts') }}">Контакти</a>
        ...
        <table class="table">
            ...
            @foreach($products as $product)
                <tr>
                    ...
                    <td><a href="{{ asset('product') }}/{{ $product->product_name }}">{{ $product->product_name }}</a></td>
